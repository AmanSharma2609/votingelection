...
Purpose   : After login page (user can see followed candidate, party, and constituency post)
*/
        ...
        items("POST", this.state.userCommentAdd, constants.userCommentAdd)
          .then(response => {
            ...
            else
            {
              ...
              {
                this.state.newsArray.splice(this.state.postIndex, 1);
                  this.setState({openComment : false});
                  this.setState({newsArray : this.state.newsArray});
                  this.setState({ snackMsg: 'This activity/news is no longer available.' });
      ...
      <div className="AppUserLogin userElection userDashboard" onScroll={this.handleRecentPostScroll}>
        ...
        <Container fluid={true} className="">
          ...
          <ErrorSnackBar open={this.state.commentNewsError}
            ...
            message={this.state.hello}
          />
          <ErrorSnackBar open={this.state.snackOpen}
            onClose={this.handleCloseNews}
            anchorOrigin={{ vertical, horizontal }}
          ...
          <Row className="">
            <Col className="homeArea" sm={12} xs={12} lg={12} md={12} xl={12} >
              <p className="mt-3 fontRegular12 greyFontColor"><NavLink className="breadCrumbs" to=''>Home</NavLink> / User Timeline</p>
            </Col>
          </Row>
        </Container>
                                              ...
                                              <div className="card p-2 cardRadius mb-1">
                                                ...
                                                <Row className="ml-0 mr-0 fontSemiBold12 pl-0 pr-0">
                                                  <Col xs={7} className="d-flex align-items-center ml-0 mr-0 pl-0 pr-0">
                                                    ...
                                                    {item.user_name === this.state.userData.user_name ? <span className="ml-3 cursorPointer"
                                    ...
                                    <Row className="mt-2">
                                      <Col xs={12}>
                                        <input type="text"
                                          ...
                                          className="commentBoxInput fontRegular14 paddingRight-10"
                                        />
                                        <Button
                                          bssize="large"
                                          color="inherit"
                                    ...
                                    <div className="mt-3 row">
                                      <Col xs={12} sm={12} md={1} lg={1} xl={1} className="text-center">
                                        <Image className="rounded-circle mt-1 cursorPointer"
                                          ...
                                          onError={(item.follow_type === 'candidate') ? this.handleCandidateImgError : this.handlePartyImgError}
                                          >
                                        </Image>
                                      </Col>
                                      <Col xs={12} sm={12} md={11} lg={11} xl={11} className="">
                                        <div className="ml-2">
                                          <div className="fontBold14 text-md-left text-sm-center cursorPointer" onClick={this.pushToprofile.bind(this, item.follow_type, item.follow_type_id, item.name)}>{item.name}</div>
                                          <div className="fontRegular14 text-md-left text-sm-center">{item.news_title}</div>
                                          <div className="text-left greyFontColor fontRegular12 mb-2 mt-2 ql-editor p-0"
                                              ...
                                              <p className="fontRegular12 greyFontColor d-flex align-self-center mt-auto mb-auto">
                                                ...
                                                >
                                                  <img onClick={this.handleLike.bind(this, index, item.status, item.news_id)} src={item.status === 1 ? Liked : Like}
                                                    className={localStorage.getItem('userType') === 'user' && localStorage.getItem('accessToken') ? classes.iconMargin : classes.disabledIconMargin} alt="" height="15" width="15"
                                                  />
                                                </Tooltip>
                                              </p>
                                              <p className="fontRegular12 greyFontColor d-flex align-self-center mt-auto mb-auto">
                                        ...
                                        <Media className="mediaCenter cursorPointer" onClick={this.pushToprofile.bind(this, 'candidate', item.candidate_id, item.candidate_name)}>
                                          <div className="rounded-circle cardImgCont">
                                            <img width={30} className=""
                                              src={item.candidate_img_url === null || item.candidate_img_url === '' ? UserIcon : item.candidate_img_url} alt=""
                                              onError={this.handleCandidateImgError}
                                            />
                                          </div>
...
UserDashboard = withRouter(UserDashboard)
